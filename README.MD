...
| REPOSITORIES_HASHICORP_GPG   | no       | `https://apt.releases.hashicorp.com/gpg`                                           | defined default                                                                                                                  |                                                                                                                                                                        |                                                                                                                                                                                                                                |
| REPOSITORIES_HASHICORP_ENTRY | no       | `'https://apt.releases.hashicorp.com $(lsb_release -cs) main'`                     | defined default                                                                                                                  |                                                                                                                                                                        |                                                                                                                                                                                                                                |
| REPOSITORIES_DOCKER_GPG      | no       | `https://download.docker.com/linux/ubuntu/gpg`                                     | defined default                                                                                                                  |                                                                                                                                                                        |                                                                                                                                                                                                                                |
| REPOSITORIES_DOCKER__ENTRY   | no       | `'https://download.docker.com/linux/ubuntu $(lsb_release -cs) stable'`             | defined default                                                                                                                  |                                                                                                                                                                        |                                                                                                                                                                                                                                |
| REPOSITORIES_MICROSOFT_GPG   | no       | `https://packages.microsoft.com/keys/microsoft.asc`                                | defined default                                                                                                                  |                                                                                                                                                                        |                                                                                                                                                                                                                                |
| REPOSITORIES_MICROSOFT_ENTRY |          | `'https://packages.microsoft.com/repos/azure-cli/ $(lsb_release -cs) main'`        | defined default                                                                                                                  |                                                                                                                                                                        |                                                                                                                                                                                                                                |
| BINARIES_GITHUB_URI          | no       | `https://api.github.com/repos`                                                     | defined default                                                                                                                  |                                                                                                                                                                        |                                                                                                                                                                                                                                |
| BINARIES_GOOGLE_URI          | no       | `https://packages.cloud.google.com/apt/dists/cloud-sdk/main/binary-arm64/Packages` | defined default                                                                                                                  |                                                                                                                                                                        |                                                                                                                                                                                                                                |
...
The build script which creates the `Dockerfile` from template.d with your settings from `build.yaml`.
